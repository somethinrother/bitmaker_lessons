...
# and can fit at least 150 people. These results should be stored
# in an array.

valid_venues = venues.select do |h|
  h[:wheelchair_accessible] == true && h[:capacity] >= 150
end

puts valid_venues.inspect
