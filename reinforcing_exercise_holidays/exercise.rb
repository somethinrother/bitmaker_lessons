...
my_cohort = Cohort.new(start_date)

test_day = Date.new(2017,10,24)
test_day2 = Date.new(2017,10,25)
test_day3 = Date.new(2017,11,12)
test_day4 = Date.new(2017,11,25)

puts my_cohort.coffee_code_day?(test_day)
puts my_cohort.coffee_code_week?(test_day4)

puts my_cohort.week_of(test_day3)

my_cohort.weeks_of_cohort

puts my_cohort.double_check_holiday(test_day4)
